...
#include "brazo_hardware/brazo_system.hpp"
...
namespace brazo_hardware
{
  hardware_interface::CallbackReturn BrazoHardwareComponent::on_init(
      const hardware_interface::HardwareInfo &info)
  {
    ...
    if (j1_gain <= 0)
    {
      RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "PID values not supplied, using defaults.");
      j1_gain = 1.0;
    }
    ...
    for (const hardware_interface::ComponentInfo &joint : info_.joints)
    {
      ...
      {
        RCLCPP_FATAL(
            rclcpp::get_logger("BrazoHardwareComponent"),
  ...
  std::vector<hardware_interface::StateInterface> BrazoHardwareComponent::export_state_interfaces()
  {
  ...
  std::vector<hardware_interface::CommandInterface> BrazoHardwareComponent::export_command_interfaces()
  {
  ...
  hardware_interface::CallbackReturn BrazoHardwareComponent::on_configure(
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Configuring ...please wait...");
    // RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), std::string(cfg_.device));
    // RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), std::string(cfg_.baud_rate));
    // RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), std::string(cfg_.timeout_ms));
    if (comms_.connected())
    {
      comms_.disconnect();
    }
    comms_.connect(cfg_.device, cfg_.baud_rate, cfg_.timeout_ms);
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Successfully configured!");

    return hardware_interface::CallbackReturn::SUCCESS;
  }

  hardware_interface::CallbackReturn BrazoHardwareComponent::on_cleanup(
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Cleaning up ...please wait...");
    if (comms_.connected())
    {
      comms_.disconnect();
    }
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Successfully cleaned up!");

    return hardware_interface::CallbackReturn::SUCCESS;
  }

  hardware_interface::CallbackReturn BrazoHardwareComponent::on_activate(
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Activating ...please wait...");
    if (!comms_.connected())
    {
      return hardware_interface::CallbackReturn::ERROR;
    }
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Successfully activated!");

    return hardware_interface::CallbackReturn::SUCCESS;
  }

  hardware_interface::CallbackReturn BrazoHardwareComponent::on_deactivate(
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Deactivating ...please wait...");
    RCLCPP_INFO(rclcpp::get_logger("BrazoHardwareComponent"), "Successfully deactivated!");

    return hardware_interface::CallbackReturn::SUCCESS;
  }

  hardware_interface::return_type BrazoHardwareComponent::read(
  ...
  hardware_interface::return_type brazo_hardware ::BrazoHardwareComponent::write(
      const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
  {
    if (!comms_.connected())
    {
...
PLUGINLIB_EXPORT_CLASS(
    brazo_hardware::BrazoHardwareComponent, hardware_interface::SystemInterface)