...
def generate_launch_description():
    ...
    rviz_base = os.path.join(
        get_package_share_directory("brazo_moveit_config"), "launch"
    )
    ...
    delayed_brazo_controller_spawner = RegisterEventHandler(
        event_handler=OnProcessExit(
            target_action=joint_state_broadcaster_spawner,
            on_exit=[brazo_controller_spawner],
        )
    )
    ...
    return LaunchDescription(
        [
            ...
            delayed_brazo_controller_spawner
        ]
    )